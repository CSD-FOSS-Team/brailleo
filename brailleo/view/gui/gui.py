...
class Brailleo(QMainWindow):
    ...
    def initUI(self):
        ...
        exitAction.setStatusTip('Exit Brailleo')
        ...
        openAction.setStatusTip('Open Text')
        openAction.triggered.connect(self.openo)

        saveAction = QAction(QIcon('save.png'), 'Save', self)
        saveAction.setShortcut('Ctrl+S')
        saveAction.setStatusTip('Save Text')
    ...
    def closeEvent(self, event):
        ...
        if reply == QMessageBox.Yes:
            self.statusBar().showMessage('Quitting Brailleo...')
            event.accept()
        else:
            event.ignore()
            self.save()
    ...
    def about(self):
        url = "https://github.com/CSD-FOSS-Team/brailleo/blob/master/README.md"
        self.statusBar().showMessage('Loading readme...')
        webbrowser.open(url)
